...
| `/ferrite ai brain-cache on\|off\|status` | Brain mobs (villagers and the like) walk their behavior table through a flat copy, rebuilt when the table changes; same behaviors, same order. Session only; `-Dferrite.ai.braincache=false`. | **on** |
